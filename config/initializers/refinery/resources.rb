...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "ac2090cb9e9bc99d11b815b17b77d168a5e02e20ea12b092"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/anfleene/opsworks_rails_demo/public/system/refinery/resources"
